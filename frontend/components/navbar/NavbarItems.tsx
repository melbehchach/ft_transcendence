...
import ProfileIcon from "./icons/ProfileIcony";
import ChatIcon from "./icons/ChatIcony";
import GameIcon from "./icons/GameIcon";
import LogoutIcon from "./icons/LogoutIcony";
  ...
  return (
    <div
      className={
        ...
        " sm:flex sm:pt-10 w-full h-full bg-background border-black border-r-2 xl:border-r-4 flex-col items-center gap-[-2rem] py-10"
      }
    >
